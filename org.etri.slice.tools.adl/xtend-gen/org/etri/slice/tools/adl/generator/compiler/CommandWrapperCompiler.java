...
public class CommandWrapperCompiler {
  ...
  public CharSequence compileWrapper(final AgentDeclaration agent, final CommandSet it) {
    ...
    _builder.newLine();
    _builder.append("import org.etri.slice.api.device.Device;");
    _builder.newLine();
  ...
  private CharSequence body(final CommandSet it, final ImportManager importManager) {
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.append("private static Logger s_logger = LoggerFactory.getLogger(SeatControlCommander.class);");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("private Device m_device;");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.append("ControlService control = m_device.getService(ControlService.class);");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    CharSequence _compileSuperType = this.compileSuperType(it.getControl(), importManager);
      ...
      if (_tripleNotEquals) {
        {
          ...
          for(final Feature f : _features) {
            CharSequence _compileFeature = this.compileFeature(f, it, importManager);
            _builder.append(_compileFeature);
            _builder.newLineIfNotEmpty();
            _builder.newLine();
          }
