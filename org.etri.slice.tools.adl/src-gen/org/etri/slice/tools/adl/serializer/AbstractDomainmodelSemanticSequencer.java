...
public abstract class AbstractDomainmodelSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == DomainmodelPackage.eINSTANCE)
			...
			case DomainmodelPackage.AGENCY:
				sequence_Agency(context, (Agency) semanticObject); 
				return; 
			...
			case DomainmodelPackage.BEHAVIOR_SET:
				sequence_BehaviorSet(context, (BehaviorSet) semanticObject); 
				return; 
			...
			case DomainmodelPackage.COMMAND_SET:
				sequence_CommandSet(context, (CommandSet) semanticObject); 
				return; 
	...
	/**
	 * Contexts:
	 *     Agency returns Agency
	 *
	 * Constraint:
	 *     (ip=STRING port=INT)
	 */
	protected void sequence_Agency(ISerializationContext context, Agency semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.AGENCY__IP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DomainmodelPackage.Literals.AGENCY__IP));
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.AGENCY__PORT) == ValueTransient.YES)
	...
	/**
	 * Contexts:
	 *     AbstractElement returns AgentDeclaration
	 *     AgentDeclaration returns AgentDeclaration
	 *
	 * Constraint:
	 *     (agency=Agency name=ValidID ruleSet=RuleSet behaviorSet=BehaviorSet commandSets+=CommandSet*)
	 */
	...
	/**
	 * Contexts:
	 *     BehaviorSet returns BehaviorSet
	 *
	 * Constraint:
	 *     behaviors+=Behavior+
	 */
	protected void sequence_BehaviorSet(ISerializationContext context, BehaviorSet semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *
	 * Constraint:
	 *     (name=STRING situation=Situation action=Action)
	 */
	protected void sequence_Behavior(ISerializationContext context, Behavior semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.BEHAVIOR__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DomainmodelPackage.Literals.BEHAVIOR__NAME));
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.BEHAVIOR__SITUATION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DomainmodelPackage.Literals.BEHAVIOR__SITUATION));
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.BEHAVIOR__ACTION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DomainmodelPackage.Literals.BEHAVIOR__ACTION));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getBehaviorAccess().getNameSTRINGTerminalRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getBehaviorAccess().getSituationSituationParserRuleCall_2_0(), semanticObject.getSituation());
		feeder.accept(grammarAccess.getBehaviorAccess().getActionActionParserRuleCall_3_0(), semanticObject.getAction());
		feeder.finish();
	}
	...
	protected void sequence_Call(ISerializationContext context, Call semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.ACTION__ACTION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DomainmodelPackage.Literals.ACTION__ACTION));
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.CALL__CONTROL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DomainmodelPackage.Literals.CALL__CONTROL));
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.CALL__METHOD) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DomainmodelPackage.Literals.CALL__METHOD));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_CommandContext(ISerializationContext context, CommandContext semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.COMMAND_CONTEXT__CONTEXT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DomainmodelPackage.Literals.COMMAND_CONTEXT__CONTEXT));
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.COMMAND_CONTEXT__PROPERTY) == ValueTransient.YES)
	...
	/**
	 * Contexts:
	 *     AbstractElement returns Context
	 *     Context returns Context
	 *     DataType returns Context
	 *
	 * Constraint:
	 *     (name=ValidID superType=JvmParameterizedTypeReference? properties+=Property*)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ValidID superType=JvmParameterizedTypeReference?)
	 */
	protected void sequence_Exception(ISerializationContext context, org.etri.slice.tools.adl.domainmodel.Exception semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     action='no-op'
	 */
	protected void sequence_NoOp(ISerializationContext context, NoOp semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.ACTION__ACTION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DomainmodelPackage.Literals.ACTION__ACTION));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getNoOpAccess().getActionNoOpKeyword_0(), semanticObject.getAction());
		feeder.finish();
	}
	...
	protected void sequence_Publish(ISerializationContext context, Publish semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.ACTION__ACTION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DomainmodelPackage.Literals.ACTION__ACTION));
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.PUBLISH__EVENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DomainmodelPackage.Literals.PUBLISH__EVENT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	 ...
	 *
	 * Constraint:
	 *     (name=ValidID group_id=STRING artifact_id=STRING)
	 */
	protected void sequence_RuleSet(ISerializationContext context, RuleSet semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.RULE_SET__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DomainmodelPackage.Literals.RULE_SET__NAME));
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.RULE_SET__GROUP_ID) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DomainmodelPackage.Literals.RULE_SET__GROUP_ID));
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.RULE_SET__ARTIFACT_ID) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DomainmodelPackage.Literals.RULE_SET__ARTIFACT_ID));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getRuleSetAccess().getNameValidIDParserRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getRuleSetAccess().getGroup_idSTRINGTerminalRuleCall_4_0(), semanticObject.getGroup_id());
		feeder.accept(grammarAccess.getRuleSetAccess().getArtifact_idSTRINGTerminalRuleCall_6_0(), semanticObject.getArtifact_id());
		feeder.finish();
	}
	...
	protected void sequence_Topic(ISerializationContext context, Topic semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.TOPIC__NAME) == ValueTransient.YES)
