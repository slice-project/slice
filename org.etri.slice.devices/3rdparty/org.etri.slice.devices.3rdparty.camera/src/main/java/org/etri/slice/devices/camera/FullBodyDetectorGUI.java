		...
		m_legs.setColumns(10);
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						BodyPartLength bodyLength = new BodyPartLength(head, torso, arms, legs);
