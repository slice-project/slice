...
public class StreamCompiler {
  ...
  protected CharSequence _body(final Context it, final ImportManager importManager) {
    StringConcatenation _builder = new StringConcatenation();
    ...
    CharSequence _serialize = importManager.serialize(this._generatorUtils.toJvmGenericType(it, this._iQualifiedNameProvider.getFullyQualifiedName(it), "context"));
  ...
  public CharSequence body(final EObject it, final ImportManager importManager) {
    if (it instanceof Context) {
      return _body((Context)it, importManager);
