...
public class DistributionGenerator implements IGenerator {
  ...
  public CharSequence compileDistributionPOM(final Resource resource) {
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("<version>1.4.10</version>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("</dependency>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("<includeArtifactIds>org.apache.felix.ipojo.handler.eventadmin,org.apache.felix.eventadmin</includeArtifactIds>");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
