...
public class DomainDeclarationImpl extends AbstractElementImpl implements DomainDeclaration
{
  ...
  {
    return DomainmodelPackage.Literals.DOMAIN_DECLARATION;
  }
  ...
  public EList<AbstractElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<AbstractElement>(AbstractElement.class, this, DomainmodelPackage.DOMAIN_DECLARATION__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DomainmodelPackage.DOMAIN_DECLARATION__ELEMENTS:
