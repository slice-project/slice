...
public abstract class AbstractDomainmodelSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Operation_SemicolonKeyword_7_q;
	protected AbstractElementAlias match_Property_SemicolonKeyword_2_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_Operation_SemicolonKeyword_7_q = new TokenAlias(false, true, grammarAccess.getOperationAccess().getSemicolonKeyword_7());
		match_Property_SemicolonKeyword_2_q = new TokenAlias(false, true, grammarAccess.getPropertyAccess().getSemicolonKeyword_2());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_Operation_SemicolonKeyword_7_q.equals(syntax))
				emit_Operation_SemicolonKeyword_7_q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if (match_Property_SemicolonKeyword_2_q.equals(syntax))
				emit_Property_SemicolonKeyword_2_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_Operation_SemicolonKeyword_7_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
	 ...
	 *     name=ValidID (ambiguity) (rule end)
	 */
	protected void emit_Property_SemicolonKeyword_2_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
