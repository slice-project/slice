...
import org.etri.slice.tools.adl.parser.antlr.DomainmodelParser;
import org.etri.slice.tools.adl.parser.antlr.internal.InternalDomainmodelLexer;
import org.etri.slice.tools.adl.scoping.DomainmodelScopeProvider;
...
public abstract class AbstractDomainmodelRuntimeModule extends DefaultXbaseRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/etri/slice/tools/adl/Domainmodel.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.etri.slice.tools.adl.Domainmodel");
	}
