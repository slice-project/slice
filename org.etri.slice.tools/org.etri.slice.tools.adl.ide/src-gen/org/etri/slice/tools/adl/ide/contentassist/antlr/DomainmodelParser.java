 ...
 * generated by Xtext
 */
package org.etri.slice.tools.adl.ide.contentassist.antlr;
...
import org.etri.slice.tools.adl.ide.contentassist.antlr.internal.InternalDomainmodelParser;
...
public class DomainmodelParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DomainmodelGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getExceptionAccess().getGroup_2(), "rule__Exception__Group_2__0");
			builder.put(grammarAccess.getControlAccess().getGroup(), "rule__Control__Group__0");
			builder.put(grammarAccess.getControlAccess().getGroup_2(), "rule__Control__Group_2__0");
			builder.put(grammarAccess.getControlAccess().getGroup_2_2(), "rule__Control__Group_2_2__0");
			...
			builder.put(grammarAccess.getBehaviorSetAccess().getGroup(), "rule__BehaviorSet__Group__0");
			builder.put(grammarAccess.getBehaviorAccess().getGroup(), "rule__Behavior__Group__0");
			builder.put(grammarAccess.getCommandSetAccess().getGroup(), "rule__CommandSet__Group__0");
			...
			builder.put(grammarAccess.getAgencyAccess().getGroup(), "rule__Agency__Group__0");
			...
			builder.put(grammarAccess.getContextAccess().getSuperTypeAssignment_2_1(), "rule__Context__SuperTypeAssignment_2_1");
			builder.put(grammarAccess.getContextAccess().getPropertiesAssignment_4(), "rule__Context__PropertiesAssignment_4");
			builder.put(grammarAccess.getEventAccess().getTopicAssignment_0(), "rule__Event__TopicAssignment_0");
			...
			builder.put(grammarAccess.getEventAccess().getPropertiesAssignment_5(), "rule__Event__PropertiesAssignment_5");
			builder.put(grammarAccess.getExceptionAccess().getNameAssignment_1(), "rule__Exception__NameAssignment_1");
			builder.put(grammarAccess.getExceptionAccess().getSuperTypeAssignment_2_1(), "rule__Exception__SuperTypeAssignment_2_1");
			builder.put(grammarAccess.getControlAccess().getNameAssignment_1(), "rule__Control__NameAssignment_1");
			builder.put(grammarAccess.getControlAccess().getSuperTypesAssignment_2_1(), "rule__Control__SuperTypesAssignment_2_1");
			builder.put(grammarAccess.getControlAccess().getSuperTypesAssignment_2_2_1(), "rule__Control__SuperTypesAssignment_2_2_1");
			builder.put(grammarAccess.getControlAccess().getFeaturesAssignment_4(), "rule__Control__FeaturesAssignment_4");
			builder.put(grammarAccess.getAgentDeclarationAccess().getAgencyAssignment_0(), "rule__AgentDeclaration__AgencyAssignment_0");
			builder.put(grammarAccess.getAgentDeclarationAccess().getNameAssignment_2(), "rule__AgentDeclaration__NameAssignment_2");
			builder.put(grammarAccess.getAgentDeclarationAccess().getRuleSetAssignment_4(), "rule__AgentDeclaration__RuleSetAssignment_4");
			builder.put(grammarAccess.getAgentDeclarationAccess().getBehaviorSetAssignment_5(), "rule__AgentDeclaration__BehaviorSetAssignment_5");
			builder.put(grammarAccess.getAgentDeclarationAccess().getCommandSetsAssignment_6(), "rule__AgentDeclaration__CommandSetsAssignment_6");
			builder.put(grammarAccess.getRuleSetAccess().getNameAssignment_1(), "rule__RuleSet__NameAssignment_1");
			builder.put(grammarAccess.getRuleSetAccess().getGroup_idAssignment_4(), "rule__RuleSet__Group_idAssignment_4");
			builder.put(grammarAccess.getRuleSetAccess().getArtifact_idAssignment_6(), "rule__RuleSet__Artifact_idAssignment_6");
			builder.put(grammarAccess.getBehaviorSetAccess().getBehaviorsAssignment_2(), "rule__BehaviorSet__BehaviorsAssignment_2");
			builder.put(grammarAccess.getBehaviorAccess().getNameAssignment_1(), "rule__Behavior__NameAssignment_1");
			builder.put(grammarAccess.getBehaviorAccess().getSituationAssignment_2(), "rule__Behavior__SituationAssignment_2");
			builder.put(grammarAccess.getBehaviorAccess().getActionAssignment_3(), "rule__Behavior__ActionAssignment_3");
			builder.put(grammarAccess.getCommandSetAccess().getControlAssignment_1(), "rule__CommandSet__ControlAssignment_1");
			builder.put(grammarAccess.getCommandSetAccess().getCommandsAssignment_3(), "rule__CommandSet__CommandsAssignment_3");
			builder.put(grammarAccess.getCommandAccess().getNameAssignment_1(), "rule__Command__NameAssignment_1");
			builder.put(grammarAccess.getCommandAccess().getContextsAssignment_3(), "rule__Command__ContextsAssignment_3");
			builder.put(grammarAccess.getCommandAccess().getActionAssignment_5(), "rule__Command__ActionAssignment_5");
			builder.put(grammarAccess.getCommandAccess().getMethodAssignment_7(), "rule__Command__MethodAssignment_7");
			builder.put(grammarAccess.getCommandContextAccess().getContextAssignment_1(), "rule__CommandContext__ContextAssignment_1");
			builder.put(grammarAccess.getCommandContextAccess().getPropertyAssignment_3(), "rule__CommandContext__PropertyAssignment_3");
			builder.put(grammarAccess.getSituationAccess().getTypesAssignment_1(), "rule__Situation__TypesAssignment_1");
			builder.put(grammarAccess.getSituationAccess().getTypesAssignment_2_1(), "rule__Situation__TypesAssignment_2_1");
			builder.put(grammarAccess.getPublishAccess().getActionAssignment_0(), "rule__Publish__ActionAssignment_0");
			builder.put(grammarAccess.getPublishAccess().getEventAssignment_1(), "rule__Publish__EventAssignment_1");
			builder.put(grammarAccess.getNoOpAccess().getActionAssignment(), "rule__NoOp__ActionAssignment");
			builder.put(grammarAccess.getCallAccess().getActionAssignment_0(), "rule__Call__ActionAssignment_0");
			builder.put(grammarAccess.getCallAccess().getControlAssignment_1(), "rule__Call__ControlAssignment_1");
			builder.put(grammarAccess.getCallAccess().getMethodAssignment_3(), "rule__Call__MethodAssignment_3");
			...
			builder.put(grammarAccess.getOperationAccess().getTypeAssignment_1(), "rule__Operation__TypeAssignment_1");
			...
			builder.put(grammarAccess.getOperationAccess().getExceptionsAssignment_6_1(), "rule__Operation__ExceptionsAssignment_6_1");
			builder.put(grammarAccess.getOperationAccess().getExceptionsAssignment_6_2_1(), "rule__Operation__ExceptionsAssignment_6_2_1");
			builder.put(grammarAccess.getTopicAccess().getNameAssignment_2(), "rule__Topic__NameAssignment_2");
			builder.put(grammarAccess.getAgencyAccess().getIpAssignment_4(), "rule__Agency__IpAssignment_4");
			builder.put(grammarAccess.getAgencyAccess().getPortAssignment_8(), "rule__Agency__PortAssignment_8");
