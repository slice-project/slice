		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getContextAccess().getGroup_2(), "rule__Context__Group_2__0");
					...
					put(grammarAccess.getCommandSetAccess().getGroup(), "rule__CommandSet__Group__0");
					put(grammarAccess.getCommandAccess().getGroup(), "rule__Command__Group__0");
					put(grammarAccess.getCommandContextAccess().getGroup(), "rule__CommandContext__Group__0");
					put(grammarAccess.getSituationAccess().getGroup(), "rule__Situation__Group__0");
					put(grammarAccess.getSituationAccess().getGroup_2(), "rule__Situation__Group_2__0");
					put(grammarAccess.getActionAccess().getGroup(), "rule__Action__Group__0");
					put(grammarAccess.getPublishAccess().getGroup(), "rule__Publish__Group__0");
					...
					put(grammarAccess.getOperationAccess().getGroup_6_2(), "rule__Operation__Group_6_2__0");
					put(grammarAccess.getTopicAccess().getGroup(), "rule__Topic__Group__0");
					put(grammarAccess.getAgencyAccess().getGroup(), "rule__Agency__Group__0");
					...
					put(grammarAccess.getContextAccess().getSuperTypeAssignment_2_1(), "rule__Context__SuperTypeAssignment_2_1");
					put(grammarAccess.getContextAccess().getPropertiesAssignment_4(), "rule__Context__PropertiesAssignment_4");
					put(grammarAccess.getEventAccess().getTopicAssignment_0(), "rule__Event__TopicAssignment_0");
					put(grammarAccess.getEventAccess().getNameAssignment_2(), "rule__Event__NameAssignment_2");
					put(grammarAccess.getEventAccess().getSuperTypeAssignment_3_1(), "rule__Event__SuperTypeAssignment_3_1");
					put(grammarAccess.getEventAccess().getPropertiesAssignment_5(), "rule__Event__PropertiesAssignment_5");
					...
					put(grammarAccess.getAgentDeclarationAccess().getRuleSetAssignment_4(), "rule__AgentDeclaration__RuleSetAssignment_4");
					put(grammarAccess.getAgentDeclarationAccess().getBehaviorSetAssignment_5(), "rule__AgentDeclaration__BehaviorSetAssignment_5");
					put(grammarAccess.getAgentDeclarationAccess().getCommandSetsAssignment_6(), "rule__AgentDeclaration__CommandSetsAssignment_6");
					put(grammarAccess.getRuleSetAccess().getNameAssignment_1(), "rule__RuleSet__NameAssignment_1");
					put(grammarAccess.getRuleSetAccess().getGroup_idAssignment_4(), "rule__RuleSet__Group_idAssignment_4");
					put(grammarAccess.getRuleSetAccess().getArtifact_idAssignment_6(), "rule__RuleSet__Artifact_idAssignment_6");
					put(grammarAccess.getBehaviorSetAccess().getBehaviorsAssignment_2(), "rule__BehaviorSet__BehaviorsAssignment_2");
					put(grammarAccess.getBehaviorAccess().getNameAssignment_1(), "rule__Behavior__NameAssignment_1");
					put(grammarAccess.getBehaviorAccess().getSituationAssignment_2(), "rule__Behavior__SituationAssignment_2");
					put(grammarAccess.getBehaviorAccess().getActionAssignment_3(), "rule__Behavior__ActionAssignment_3");
					put(grammarAccess.getCommandSetAccess().getControlAssignment_1(), "rule__CommandSet__ControlAssignment_1");
					put(grammarAccess.getCommandSetAccess().getCommandsAssignment_3(), "rule__CommandSet__CommandsAssignment_3");
					put(grammarAccess.getCommandAccess().getNameAssignment_1(), "rule__Command__NameAssignment_1");
					put(grammarAccess.getCommandAccess().getContextsAssignment_3(), "rule__Command__ContextsAssignment_3");
					put(grammarAccess.getCommandAccess().getActionAssignment_5(), "rule__Command__ActionAssignment_5");
					put(grammarAccess.getCommandAccess().getMethodAssignment_7(), "rule__Command__MethodAssignment_7");
					put(grammarAccess.getCommandContextAccess().getContextAssignment_1(), "rule__CommandContext__ContextAssignment_1");
					put(grammarAccess.getCommandContextAccess().getPropertyAssignment_3(), "rule__CommandContext__PropertyAssignment_3");
					put(grammarAccess.getSituationAccess().getTypesAssignment_1(), "rule__Situation__TypesAssignment_1");
					put(grammarAccess.getSituationAccess().getTypesAssignment_2_1(), "rule__Situation__TypesAssignment_2_1");
					put(grammarAccess.getPublishAccess().getActionAssignment_0(), "rule__Publish__ActionAssignment_0");
					put(grammarAccess.getPublishAccess().getEventAssignment_1(), "rule__Publish__EventAssignment_1");
					put(grammarAccess.getNoOpAccess().getActionAssignment(), "rule__NoOp__ActionAssignment");
					put(grammarAccess.getCallAccess().getActionAssignment_0(), "rule__Call__ActionAssignment_0");
					put(grammarAccess.getCallAccess().getControlAssignment_1(), "rule__Call__ControlAssignment_1");
