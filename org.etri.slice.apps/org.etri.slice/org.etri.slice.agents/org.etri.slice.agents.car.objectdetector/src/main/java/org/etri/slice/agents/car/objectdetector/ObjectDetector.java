 ...
 */
package org.etri.slice.agents.car.objectdetector;
...
@Provides
@Instantiate
public class ObjectDetector extends AbstractAgent implements Agent {
	
	@Property(name="groupId", value="org.etri.slice")
	public String groupId;
	
	@Property(name="artifactId", value="org.etri.slice.rules.car.objectdetector")
